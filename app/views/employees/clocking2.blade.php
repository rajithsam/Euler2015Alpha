                ...
                <div class="table-body-container">
                  ...
                  <thead>         
                    <tr style="background-color: #b32728;   color:#dcdcdc; text-transform: uppercase;">
                      ...
                      <th>Schedule</th>                   
                      <th>in-out</th>
                      <th class="hide hidden">in-out</th>
                      <th class="hide hidden">in-out</th>      
                      <th>Total Hours</th>
                      <th>Work Hours</th>                 
                      <th>Total Overtime</th>
                  ...
                  <?php foreach($getTimesheetperCutoff as $timesheet) : ?>        
                    <tr id="<?php echo $timesheet->id; ?>">
                      ...
                      <td width="115" class="edit-cell timesheet-inout1-<?php echo $timesheet->id; ?>"><?php
                      if ( !empty($timesheet->time_in_1) &&
                           !empty($timesheet->time_out_1) ) {
                            echo date('H:i', strtotime($timesheet->time_in_1)) . ' - ' . date('H:i:s', strtotime($timesheet->time_out_1));
                      ...
                      ?></td> 
                      <td width="115" class="edit-cell timesheet-inout2-<?php echo $timesheet->id; ?> hide hidden"><?php
                      if ( !empty($timesheet->time_in_2) &&
                           !empty($timesheet->time_out_2) ) {
                            echo date('H:i', strtotime($timesheet->time_in_2)) . ' - ' . date('H:i:s', strtotime($timesheet->time_out_2));
                      ...
                      ?></td>
                      <td width="115" class="edit-cell timesheet-inout3-<?php echo $timesheet->id; ?> hide hidden"><?php
                      if ( !empty($timesheet->time_in_3) &&
                           !empty($timesheet->time_out_3) ) {
                            echo date('H:i', strtotime($timesheet->time_in_3)) . ' - ' . date('H:i:s', strtotime($timesheet->time_out_3));
