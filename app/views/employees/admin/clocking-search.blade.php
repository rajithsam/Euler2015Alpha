          ...
          <div class="col-md-10">
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="table-body-container">
                  ...
                  <?php foreach($getTimesheetperCutoff as $timesheet) : ?>        
                    <tr id="<?php echo $timesheet->id; ?>">
                      ...
                      <td class="edit timesheet-inout1-<?php echo $timesheet->id; ?>"><?php echo $timesheet->time_in_1 . ' - ' . $timesheet->time_in_2; ?></td>                  
                      <td class="edit timesheet-inout2-<?php echo $timesheet->id; ?>"><?php echo $timesheet->time_in_2 . ' - ' . $timesheet->time_in_2; ?></td>
                      <td class="edit timesheet-inout3-<?php echo $timesheet->id; ?>"><?php echo $timesheet->time_in_3 . ' - ' . $timesheet->time_in_3; ?></td>      
                      <td class="timesheet-totalhours-<?php echo $timesheet->id; ?>">Total Hours</td>
                      <td class="timesheet-workhours-<?php echo $timesheet->id; ?>">Work Hours</td>                 
                      <td class="timesheet-totalovertime-<?php echo $timesheet->id; ?>">Total Overtime</td>
                      <td class="timesheet-tardiness-<?php echo $timesheet->id; ?>">Tardiness</td>                
                      <td class="timesheet-undertime-<?php echo $timesheet->id; ?>">Undertime</td>
                      <td class="timesheet-otstatus-<?php echo $timesheet->id; ?>">OT Status</td>
                    </tr>
                ...
                <nav class="pull-right">{{ $getTimesheetperCutoff->links() }}</nav>
