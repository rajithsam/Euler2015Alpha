...
<html lang="en">
  ...
  <body>
            ...
            */
            ...
            if( !empty($groups) ) :
              ...
              if ( strcmp(strtolower($groups->name), strtolower('Administrator')) === 0 ||
                  ...
                  <li class="active"><a href="{{ url('/employee/clocking') }}"><i class="fa fa-clock-o"></i> My Timesheet</a></li>
    ...
    // check all checkboxes
      ...
      //http://stackoverflow.com/questions/7445492/how-to-reset-a-select-box-using-jquery
     $(document).ready(function(){
