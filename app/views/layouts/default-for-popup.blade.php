    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="color:#FFF; font-size:12px;">Welcome to <strong>Back<span style="color:#D32728">Office</span> TimeTracker!</strong> BPO TimeTracker!</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse hide">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            ?>
              ...
              <li><a href="{{ url('/admin/dashboard') }}" style="color:#FFF; font-size:12px;">Dashboard</a></li>
           ...
           ?>
            <!--li><a href="">Hello {{ $employeeInfo[0]->lastname }}</a></li-->
            <li><a href="{{ URL::to('users/logout') }}" style="color:#FFF; font-size:12px;">Log Out</a></li>
          </ul>          
