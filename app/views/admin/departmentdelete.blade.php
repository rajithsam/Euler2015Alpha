...
<div class="page-container">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" style="font-size:14px; font-weight:bold;">Delete Department</div>
          <div class="panel-body">
            ...
            {{ Form::open(array('url' => '/admin/department/delete/'.$id, 'id' => '', 'class' => 'form-inline')) }}              
            ...
            <div class="form-group">
              ...
              <p>Are you sure you want to delete <strong>{{ $departmentDelete->name }}</strong>? </p>
            </div>            
