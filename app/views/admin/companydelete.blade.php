...
<div class="page-container">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" style="font-size:14px; font-weight:bold;">Delete Company</div>
          <div class="panel-body">
            ...
            {{ Form::open(array('url' => '/admin/company/delete/'.$id, 'id' => '', 'class' => 'form-inline')) }}              
            {{ Form::hidden('company_id', $id); }}
            <div class="form-group">
              {{-- Form::label('Company Name', 'Company Name', array('class' => 'sr-only')) --}}           
              {{-- Form::text('company_name', $companyEdit->name, array('id' => '', 'class' => 'form-control', 'placeholder' => 'Company Name')) --}}

              <p>Are you sure you want to delete <strong>{{ $companyDelete->name }}</strong>? </p>
            </div>            
              {{ Form::submit('Delete', array('class' => 'btn btn-custom-default pull-right')) }}
            </div>            
