...
<div class="page-container">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            {{ Form::open(array('url' => '/admin/jobtitle/delete/'.$id, 'id' => '', 'class' => 'form-inline')) }}              
            {{ Form::hidden('Department_id', $id); }}
            <div class="form-group">
              {{-- Form::label('Job Title Name', 'Job Title Name', array('class' => 'sr-only')) --}}           
              {{-- Form::text('job_title_name', $jobTitleEdit->name, array('id' => '', 'class' => 'form-control', 'placeholder' => 'Job Title Name')) --}}

              <p>Are you sure you want to delete <strong>{{ $jobTitleDelete->name }}</strong>? </p>
            </div>            
