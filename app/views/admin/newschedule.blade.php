...
<div class="page-container">
        ...
        <a href="{{ url('/admin/dashboard') }}" class="list-group-item active">Settings</a-->       
          ...
          <div id="content" class="col-md-10" role="main">
            ...
            <h1 class="page-header">Add User | Default Schedule</h1>       
    ...
    <table class="table table-striped table-hover display" cellspacing="0" width="100%">
        ...
        <tbody>            
            ...
            <tr>
                ...
                <!--td>Shift</td-->                
                <td><?php echo Form::select('schedule[5][restday]', array(0 => 'No', 1 => 'Yes'), 1, array()); ?></td>                
                <!--td>Hours per day</td-->                
                <td>
                <?php
                    echo Form::select(
            ...
            <tr>
                ...
                <!--td>Shift</td-->                
                <td><?php echo Form::select('schedule[6][restday]', array(0 => 'No', 1 => 'Yes'), 1, array()); ?></td>                
                <!--td>Hours per day</td-->                
                <td>
                <?php
                    echo Form::select(
