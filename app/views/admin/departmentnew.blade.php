...
<div class="page-container">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" style="font-size:14px; font-weight:bold;">Add New Department</div>
          <div class="panel-body">
            ...
            ?>
                ...
                <td><a href="{{ URL::to('/admin/department/edit/' . $department->id) }}">Edit</a> | <a href="{{ URL::to('/admin/department/delete/' . $department->id) }}">Delete</a></td>
                </tr>
