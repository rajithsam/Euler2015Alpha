	...
	if ( !empty($data['designation']) ) {
		...
		if( $data['designation'] === 1 ) { //Manager
			...
			$rules = array(
			 	   ...
			 	   $data['designation'] === 3 ) { //Supervisor or Employee
...
Route::get('/admin/user/{employeeId}/edit', array('as' => 'adminUserEdit', 'uses' => function($employeeId)
{	
	//return $employeeId;
...
Route::post('/admin/user/edit', array('as' => '', 'uses' => function()
{
...
$validator = Validator::make($data, $rules);
	...
	if ( $validator->fails() ) {
		...
		//return Redirect::to('/admin/user/new')->withErrors($validator)->withInput(Input::except('password'))->withInput(Input::except('designation'));		
	    //return Redirect::to('/admin/user/edit')->withErrors($validator)->withInput(Input::except('password'));

	    return Redirect::route('adminUserEdit')->withErrors($validator);
...
Route::get('/admin/user/{employeeId}/delete', array('as' => 'adminUserEdit', 'uses' => function($employeeId)
{	
	//return $employeeId;
...
//Route::post('/admin/search/timesheet/', array('as' => 'redrawAdminSearchTimesheet', 'uses' => function()
//Route::post('/employee/clocking/', array('as' => 'redrawAdminSearchTimesheet', 'uses' => function()

Route::post('/admin/search/timesheet/', array('as' => 'searchTimesheet', 'uses' => function()
{
	...
	if($data['search'] === 'search') {
		...
		Session::put('searchEmployeeId', $data["employeeId"]);		
		return Redirect::to('/redraw/search/timesheet');
...
Route::get( '/redraw/search/summary', array('as' => 'redrawAdminSearchSummary', 'uses' => 'EmployeesController@redrawSearchEmployeeSummary') );
...
Route::get('/admin/company/new', array('as' => 'adminNewCompany', 'uses' => function()
{
	...
	return View::make('admin.companynew');
...
Route::get('/admin/company/edit/{id}', array('as' => 'adminEditCompany', 'uses' => function($id)
{
	...
	return View::make('admin.companyedit', array('id' => $id));
...
Route::get('/admin/company/delete/{id}', array('as' => 'adminDeleteCompany', 'uses' => function($id)
{
	...
	//return 'Update Company';
	return View::make('admin.companydelete', array('id' => $id));
	//return Redirect::route('updateCompany', array('id' => $id));
...
Route::get('/admin/department/new', array('as' => 'adminNewDepartment', 'uses' => function()
{
	...
	return View::make('admin.departmentnew');
...
Route::get('/admin/department/edit/{id}', array('as' => 'adminEditDepartment', 'uses' => function($id)
{
	...
	return View::make('admin.departmentedit', array('id' => $id));
...
Route::get('/admin/department/delete/{id}', array('as' => 'adminDeleteDepartment', 'uses' => function($id)
{
	...
	//return 'Update Company';
	return View::make('admin.departmentdelete', array('id' => $id));
	//return Redirect::route('updateCompany', array('id' => $id));
...
Route::get('/admin/jobtitle/new', array('as' => 'adminNewJobTitle', 'uses' => function()
{
	...
	return View::make('admin.jobtitlenew');
...
Route::get('/admin/jobtitle/edit/{id}', array('as' => 'adminEditJobTitle', 'uses' => function($id)
{
	...
	$id = (int) $id;
	//return 'Update Department';
	return View::make('admin.jobtitleedit', array('id' => $id));
...
Route::get('/admin/jobtitle/delete/{id}', array('as' => 'adminDeleteJobTitle', 'uses' => function($id)
{
	...
	//return 'Update Company';
	return View::make('admin.jobtitledelete', array('id' => $id));
